...
import 'package:chatapp_dn_project/chat.dart';
import 'package:chatapp_dn_project/const.dart';
import 'package:chatapp_dn_project/settings.dart';
import 'package:chatapp_dn_project/widget/loading.dart';
...
class HomeScreenState extends State<HomeScreen> {
  ...
  void showNotification(message) async {
    var androidPlatformChannelSpecifics = new AndroidNotificationDetails(
      Platform.isAndroid ? 'com.example.chatapp_dn_project' : 'com.duytq.chatapp_dn_project',
      'Chat app DN Project',
